            ...
            <section class="forth" id="page4">
                 ...
                 <div class="mes-contain">
                  <div class="contact-icon">
                      ...
                      <a href="javascript:void(0);"><img  id="weixin" src="/W3CAY/Public/Home/IMG/weixin.png"></a>
                  </div>
                 ...
                 <input type="text" value="你的名字" onfocus="this.value=''" class="inp inp-name">
                 <input type="text" value="你的邮箱" onfocus="this.value=''" class="inp inp-mail">
                     </span>
