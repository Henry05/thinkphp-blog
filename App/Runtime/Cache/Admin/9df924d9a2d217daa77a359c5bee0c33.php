...
<!-- <div class="admin">Admin</div> -->
 <div  class="box">
		...
		<form class="from" action='/W3CAY/index.php/Admin/Index/do_login'  method='post'>
		...
		<span>验证码：<input class="inpt"type="text" name="code" style="width:80px  ;border:1px solid #9595ec; "><img id="code" src="/W3CAY/admin/Public/code" onclick='this.src=this.src+"?"+Math.random;' ></span>
