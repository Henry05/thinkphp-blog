...
<link rel="stylesheet" type="text/css" href="/Blog/Public/Admin/CSS/category.css">
 ...
 <table class="table">
	...
	<?php if(is_array($cate)): foreach($cate as $key=>$v): ?><tr >
		...
		<td class="cate-td">
			...
			<a class="btn" href="/Blog/index.php/cay_admin/Category/delcate/c_id/<?php echo ($v["c_id"]); ?>" >删除</a>
