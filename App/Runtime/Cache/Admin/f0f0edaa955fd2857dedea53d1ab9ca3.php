...
<html>
    ...
    <body>
        ...
        <div  class="box">
            ...
            <form class="from" action='/W3CAY/index.php/Admin/Login/login'  method='post'>
                ...
                <span>验证码：<input class="inpt"type="text" name="code" style="width:80px;border:1px solid #9595ec; "><img id="code" src="/W3CAY/index.php/Admin/Public/code" onclick='this.src=this.src+"?"+Math.random;' ></span>
