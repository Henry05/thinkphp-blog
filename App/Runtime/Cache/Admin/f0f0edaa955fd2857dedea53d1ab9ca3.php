...
<html>
    ...
    <body>
        <div  class="box">
            ...
            <form class="from" action='/Blog/index.php/cay_admin/Login/login'  method='post'>
                ...
                <span>验证码：<input class="inpt"type="text" name="code" style="width:80px;border:1px solid #9595ec; "><img id="code" src="/Blog/index.php/cay_admin/Public/code" onclick='this.src=this.src+"?"+Math.random;' ></span>
